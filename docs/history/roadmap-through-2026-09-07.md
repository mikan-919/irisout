...
この文書は2026-09-07の方針更新前の計画と完了記録を保存したものである。本文中の「次の作業」や節番号は当時の記述として読む。現在の開発順序は[ROADMAP.md](../../ROADMAP.md)、方針は[開発方針](../project-direction.md)、実装状況は[STATUS.md](../../STATUS.md)を参照する。本文中のコード表記のパスはリポジトリのルートを基準とする。
...
[`docs/heatmap-readiness.md`](../heatmap-readiness.md)を参照。
